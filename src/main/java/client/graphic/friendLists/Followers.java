...
public class Followers implements BackToFriendsButton, MenuButton, CloseButton, ScrollPaneFromBottom {
    public void followers(LinkedList<String> followers){
