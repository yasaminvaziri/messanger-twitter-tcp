...
public class ReportList implements BackToFriendsButton, MenuButton, CloseButton, ScrollPaneFromBottom {
    public void reportList(LinkedList<String> reportList){
