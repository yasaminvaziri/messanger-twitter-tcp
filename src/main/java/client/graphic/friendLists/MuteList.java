...
public class MuteList implements BackToFriendsButton, MenuButton, CloseButton, ScrollPaneFromBottom {
    public void muteList(LinkedList<String> muteList){
